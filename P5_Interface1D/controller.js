    ...
    update() {
        ...
        switch(this.gameState) {
            ...
            case "PLAY":
                ...
                if (alien.position == cow.position)  {
            ...
            case "COLLISION":
                ...
                if (frameToShow == collisionAnimation.animation.length-1)  {
                    ...
                    // We haven't hit the max score yet, keep playing    
                        ...
                        cow.position = parseInt(random(0,displaySize));  // move the target to a new random position
            ...
            case "SCORE":       
                ...
                cow.position = parseInt(random(1,displaySize));
